...
/*
 * Documentation:
 * Badge — https://app.subframe.com/007b7d1e11bb/library?component=Badge_97bdb082-1124-4dd7-a335-b14b822d0157
 */
...
const BadgeRoot = React.forwardRef<HTMLElement, BadgeRootProps>(function BadgeRoot(
  ...
  return (
    ...
    >
      <SubframeCore.Icon
        className={SubframeCore.twClassNames("font-caption text-caption text-brand-700", {
      ...
      {children ? (
        <span
          className={SubframeCore.twClassNames("whitespace-nowrap font-caption text-caption text-brand-800", {
            "text-success-800": variant === "success",
            "text-warning-800": variant === "warning",
