...
/*
 * Documentation:
 * Accordion — https://app.subframe.com/007b7d1e11bb/library?component=Accordion_d2e81e20-863a-4027-826a-991d8910efd9
 */
...
const Chevron = React.forwardRef<HTMLElement, ChevronProps>(function Chevron(
  ...
  return (
    <SubframeCore.Collapsible.Chevron {...otherProps}>
      <SubframeCore.Icon
        className={SubframeCore.twClassNames("font-body text-body text-default-font", className)}
...
const Content = React.forwardRef<HTMLElement, ContentProps>(function Content(
  ...
  return children ? (
    <SubframeCore.Collapsible.Content asChild={true} {...otherProps}>
      <div className={SubframeCore.twClassNames("flex w-full flex-col items-start gap-2", className)} ref={ref as any}>
        {children}
      </div>
...
const Trigger = React.forwardRef<HTMLElement, TriggerProps>(function Trigger(
  ...
  return children ? (
    <SubframeCore.Collapsible.Trigger asChild={true} {...otherProps}>
      <div
        className={SubframeCore.twClassNames("flex w-full cursor-pointer flex-col items-start gap-2", className)}
        ref={ref as any}
      >
        {children}
      </div>
...
const AccordionRoot = React.forwardRef<HTMLElement, AccordionRootProps>(function AccordionRoot(
  ...
  return (
    <SubframeCore.Collapsible.Root asChild={true} {...otherProps}>
      <div
        className={SubframeCore.twClassNames("group/d2e81e20 flex w-full flex-col items-start rounded-md", className)}
        ref={ref as any}
      >
        <Trigger>
          {trigger ? (
