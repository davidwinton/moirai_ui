...
/*
 * Documentation:
 * Icon Button — https://app.subframe.com/007b7d1e11bb/library?component=Icon+Button_af9405b1-8c54-4e01-9786-5aad308224f6
 */
...
const IconButtonRoot = React.forwardRef<HTMLElement, IconButtonRootProps>(function IconButtonRoot(
  {
      ...
      <SubframeCore.Icon
        className={SubframeCore.twClassNames(
          "font-heading-3 text-heading-3 text-neutral-700 group-disabled/af9405b1:text-neutral-400",
          {
            ...
            "text-white group-hover/af9405b1:text-white": variant === "inverse",
      ...
      <SubframeCore.Loader
        className={SubframeCore.twClassNames(
          "hidden font-caption text-caption text-neutral-700 group-disabled/af9405b1:text-neutral-400",
          {
            ...
            "text-white": variant === "inverse" || variant === "destructive-primary" || variant === "brand-primary",
