...
const AvatarRoot = React.forwardRef<HTMLElement, AvatarRootProps>(function AvatarRoot(
  ...
  return (
    ...
    >
      ...
      {image ? (
        <img
          className={SubframeCore.twClassNames("absolute h-8 w-8 flex-none object-cover", {
