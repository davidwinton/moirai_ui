...
const ButtonRoot = React.forwardRef<HTMLElement, ButtonRootProps>(function ButtonRoot(
  ...
  return (
    ...
    >
      <SubframeCore.Icon
        className={SubframeCore.twClassNames(
          "font-body text-body text-white group-disabled/3b777358:text-neutral-400",
          {
            ...
            "text-neutral-700":
              variant === "neutral-tertiary" || variant === "neutral-secondary" || variant === "neutral-primary",
      ...
      />
      <div
        className={SubframeCore.twClassNames("hidden h-4 w-4 flex-none items-center justify-center gap-2", {
          flex: loading,
      ...
      >
        <SubframeCore.Loader
          className={SubframeCore.twClassNames(
            ...
            {
              "inline-block font-['Inter'] text-[12px] font-[400] leading-[20px] tracking-normal": loading,
